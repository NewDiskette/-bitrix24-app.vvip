<?php
define('C_REST_CLIENT_ID','local.62f480d586fa52.77453657');//Application ID
define('C_REST_CLIENT_SECRET','ZrdP0N2OqRaOvGe0y7BmCDKhoMD1G89MO08YjuHhezVOHmwO5t');//Application key
// or
